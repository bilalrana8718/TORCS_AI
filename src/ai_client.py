...
parser = argparse.ArgumentParser(description='AI Python client to connect to the TORCS SCRC server.')
...
d = ai_driver.AIDriver(arguments.stage)
...
print("AI racing client finished successfully!")
sock.close() 